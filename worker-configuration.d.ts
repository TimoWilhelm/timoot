/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2aa0fef37320bb0e78861b819c7402dd)
// Runtime types generated with workerd@1.20251217.0 2025-11-17 nodejs_als
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "QuizStoreDurableObject" | "GameRoomDurableObject";
	}
	interface Env {
		KV_IMAGES: KVNamespace;
		KV_SYNC: KVNamespace;
		...
		QUIZ_STORE: DurableObjectNamespace<import("./worker/index").QuizStoreDurableObject>;
