	...
	theme: {
		extend: {
			...
			boxShadow: {
				...
				glow: '0 0 20px -5px rgba(244, 129, 32, 0.4)',
				'glow-lg': '0 0 40px -10px rgba(244, 129, 32, 0.3)',
			...
			keyframes: {
				...
				glow: {
					'0%, 100%': {
						boxShadow: '0 0 20px -5px rgba(244, 129, 32, 0.4)',
					},
					'50%': {
						boxShadow: '0 0 40px -5px rgba(244, 129, 32, 0.6)',
					},
				},
				float: {
					'0%, 100%': {
			...
			backgroundImage: {
				'gradient-rainbow': 'linear-gradient(135deg, #f48120 0%, #faad3f 25%, #ff6b4a 50%, #f48120 75%, #faad3f 100%)',
				'gradient-primary': 'linear-gradient(135deg, #f48120, #e55a1b)',
				'gradient-mesh':
